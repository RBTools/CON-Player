        ...
        public bool ReadMIDIFile(string midi, bool output_info = true)
        {
            ...
            try
            {
                ...
                for (var i = 0; i < MIDIFile.Events.Tracks; i++)
                {
                    ...
                    else if (trackname.Contains("BASS") && !trackname.Contains("REAL") && !trackname.Contains("BAND") && !trackname.Contains("COOP"))
                    {
                        List<MIDINote> toadd;
                    ...
                    else if ((trackname.Contains("GUITAR") && !trackname.Contains("REAL") && !trackname.Contains("COOP")) || trackname.Contains("T1 GEMS"))
                    {
                        List<MIDINote> toadd;
